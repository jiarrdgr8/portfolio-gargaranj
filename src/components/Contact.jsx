...
const Contact = () => {
  ...
  return (
    <section className="min-h-fit max-w-7xl flex flex-col mx-auto justify-center items-center py-16 px-5 text-center text">
      ...
      <p className="max-w-xl font-light text-gray-500 mb-2 text-sm pt-6 md:text-base justify-evenly">
        Are you looking for a backend/full stack developer? I am open for
        freelancing or full-time opportunities. Feel free to contact me using
      ...
      <p className="max-w-xl font-light text-gray-500 mb-2 text-sm pt-2 md:text-base justify-evenly">
      ...
      <div className="w-6/12 max-w-48 min-w-[360px] md:w-4/6 sm:w-4/6 custom-width:w-4/6">
        <div className="pt-4 text-left w-full">
          <form
            action="https://getform.io/f/650f070b-2d9e-42ca-bf08-702fce21708f"
            method="POST"
          >
